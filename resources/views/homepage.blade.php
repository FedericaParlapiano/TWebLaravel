...
<script type="text/javascript">
        ...
        <span>Regolamento</span> 
            <a href="risorse/Regolamento.pdf"> <button id="visualizza" onclick="" class="button ourblue"> <i class="fa-solid fa-file-pdf"></i> Visualizza</button></a>
            <a href="risorse/Regolamento.pdf" download> <button id="download" onclick="" class="button ourblue"> <i class="fa-solid fa-download"></i> Download</button></a>
        </div>
